...
// service active
$('.s-single-Nos Services').on('mouseenter', function () {
	$(this).addClass('active').parent().siblings().find('.s-single-Nos Services').removeClass('active');
})
